// Chips and Salsa Programming Challenge
#include <iostream>
#include <iomanip>
#include <string>
using namespace std;
...
int main()
{
	...
	// Subscript of salsa that sold the most
...
* the salsas, and teh sales array parameter will hold       *
* the numbers sold of each corresponding type of salsa.     *
*************************************************************/
